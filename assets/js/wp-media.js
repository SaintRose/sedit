jQuery(document).ready(function($) {
  ...
  $(".addSingleMedia").click(function(e) {
    ...
    metaImageFrame.on("select", function() {
      ...
      $(".term-group-" + dataID).append(
        '<img class="hide-img hide-img-' + dataID + '" src="' + url + '">'
      );
    });
    metaImageFrame.open();
  });
  ...
  $(".addMultiMedia").click(function(e) {
    ...
    custom_uploader.on("select", function() {
      ...
      selection.map(function(attachment) {
        ...
        $(".sort-images-" + dataID).append(
          '<div class="image-theme ui-sortable-handle"><input name="' +
            nameField +
            '[]" value="' +
            attachment.id +
            '" type="hidden"><img src="' +
